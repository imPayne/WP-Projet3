...
<main>
    <div class="w-full h-auto p-6 bg-gradient-to-r from-pink-light to-pink-strong flex flex-col items-center" id="section1">
        <h1 class="m-2 mt-14 text-5xl font-nunito tracking-tight font-bold text-white md:text-xl"><?php the_field('titletarifs') ?></h1>
        <div class="my-10 flex md:flex-row flex-col">
                <?php
                if (have_rows('boxtarifs')):
                    ...
                    ?>
                <div class="my-4 mx-6 p-6 w-auto h-auto bg-white flex justify-center items-center rounded-lg md:py-6">
                    <div class="flex flex-col items-center md:p-4">
                        ...
                        <p class="mt-10 text-3xl font-semibold md:text-5xl"><?php echo $price ?></p>
                        <p class="mt-6 mb-10 text-3xl font-semibold md:text-5xl"><?php echo $priceNbr ?></p>
                        <ul>
